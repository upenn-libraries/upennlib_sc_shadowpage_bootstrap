...
<head>
    ...
    echo head_css();
    ?>
    <link rel="stylesheet" type="text/css" href="<?php echo css_src('jquery.bxslider'); ?>" />

  <script src="<?php echo src('jquery.min', 'javascripts', 'js'); ?>"></script>
  <script src="<?php echo src('jquery.bxslider.min', 'javascripts', 'js'); ?>"></script>
...
<?php echo body_tag(array('id' => @$bodyid, 'class' => @$bodyclass)); ?>
    ...
    <?php fire_plugin_hook('public_body', array('view'=>$this)); ?>
        ...
        <?php fire_plugin_hook('public_header', array('view'=>$this)); ?>
        <div class="site-title-text"><?php echo link_to_home_page(option('site_title')); ?></div>    <?php // Eventually remove the container to set the menu through screen. ?>
